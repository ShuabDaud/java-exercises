...
public class DateExercises {
    ...
    public static LocalDate getIndependenceDay() {
        ...
        LocalDate independenceDate = LocalDate.of(1776, Month.JULY, 4);
    ...
    public static String compareDates(LocalDate date1, LocalDate date2) {
        ...
        return date1.compareTo(date2) < 0
                ? "before" : date1.compareTo(date2) > 0
                ? "after" : "equal";
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("MMMM d, yyyy: " + formatDate(today, "MM-dd-yyyy"));
        System.out.println("yyyy-MMMM-dd: " + formatDate(today, "YY-MMM-dd"));
